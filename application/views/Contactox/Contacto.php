						...
						<div class="col-md-2"></div>
  						<div class="col-xs-8 col-md-4">  							
    						<a href="https://www.facebook.com/profile.php?id=100011595570342" class="thumbnail" target="_blank">
      						<img src=<?php echo base_url("Content/img/fb.png") ?> width="40" weight="40" alt="...">
    						</a>
  						</div>
  						<div class="col-xs-8 col-md-4">
    						<a href="https://twitter.com/DriveControlads" class="thumbnail"  target="_blank">
      						<img src=<?php echo base_url("Content/img/tw.png") ?> width="40" weight="40" alt="Twitter DriveControl">
    						</a>
  						</div>
  					</div>
				</div>				
					...
					<div class="panel-heading"><center><strong><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> Contacto</strong></center></div>
					  ...
					  <form action=<?php echo site_url("Conctactos/enviarCorreo") ?> role="form" method="post">
							...
							<div class="input-group">
							  	...
							  	<input type="email" name="correo" class="form-control" placeholder="Ejemplo: correo@example.com" aria-describedby="basic-addon1" required>
							</div><br>
							<div class="input-group">
							  	<span class="input-group-addon" id="telefono">Telefono: </span>
							  	<input type="tel" name="telefono" class="form-control" placeholder="Opcional" aria-describedby="basic-addon1">
							</div><br>
							<div class="input-group">
							  	<span class="input-group-addon" id="asunto">Asunto: *</span>
							  	<input type="text" name="asunto" class="form-control" placeholder="Obligatorio" aria-describedby="basic-addon1" required>
							</div><br>
							<div class="input-group">
