...
<body  id="prin">
	<div class="row" id="header">
		...
		<div class="col-md-2"><?php echo $_SESSION['usuario']?><br><button type="button" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> CERRAR SESION</button></div>		
	</div>
	<div class="row">		
	</div>
	<footer id="pie">		
