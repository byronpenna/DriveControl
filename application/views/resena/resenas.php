  ...
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      <div class="col-md-8"><br><br><br>
        <div class="panel panel-primary">
          <div class="panel-heading"><center><strong><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Deja tu comentario </strong></center></div>
            <div class="panel-body"><br><br>
            <div class="row">
            <div class="col-md-1"></div>
            <div class="col-md-8">
              <div class="input-group">
                  <span class="input-group-addon" id="mensaje">Comentario: *</span>
            ...
            <button class="btn btn-primary" type="button">            
                <span class="glyphicon glyphicon-play" aria-hidden="true"></span> Enviar
            </button>
            </center>             
            </div><br><br>
          </div>
